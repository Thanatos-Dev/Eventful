...
{
    public class SunnyDayMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/SunnyDayMusic"), ModContent.ItemType<SunnyDayMusicBox>(), ModContent.TileType<SunnyDayMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SunnyDayMusicBoxTile>(), 0);
        }
    }
}