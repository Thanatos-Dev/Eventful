using Eventful.Tiles.MusicBoxes;
using Terraria.ID;
using Terraria.ModLoader;

namespace Eventful.Items.MusicBoxes
{
    public class BuriedBarrageMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/BuriedBarrageMusic"), ModContent.ItemType<BuriedBarrageMusicBox>(), ModContent.TileType<BuriedBarrageMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<BuriedBarrageMusicBoxTile>(), 0);
        }
    }
}