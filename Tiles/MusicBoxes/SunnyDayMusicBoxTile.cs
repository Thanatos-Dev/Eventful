...
{
    public class SunnyDayMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(255, 247, 168), Language.GetText("ItemName.MusicBox"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SunnyDayMusicBox>();
        }
