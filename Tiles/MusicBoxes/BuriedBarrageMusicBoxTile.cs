...
namespace Eventful.Tiles.MusicBoxes
{
    public class BuriedBarrageMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(156, 62, 98), Language.GetText("ItemName.MusicBox"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<BuriedBarrageMusicBox>();
        }
